    ...
    <div className="w-full h-fit bg-secondary flex flex-col justify-center items-center py-20">
      <div className="w-4/5 mx-10 md:mx-10 xl:mx-14">
        ...
        <p
          ...
          data-aos-delay="150"
          data-aos-duration="500"
          className={`${aspekta.className} text-lg md:text-xl font-medium text-[#CCCCCC] mt-5`}
        >
        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            <img
              ...
              alt="Name"
            />
            <h1 className={`${aspekta.className} text-3xl my-3`}>
              {testimonial.name}
            </h1>
            {testimonial.testimonial.split(/\n/g).map((line, i) =>
              line.trim() === "" ? (
                ...
                <p
                  key={i}
                  className={`${aspekta.className} text-base text-[#333333] my-1`}
                >
                  {line}
                </p>
              )
